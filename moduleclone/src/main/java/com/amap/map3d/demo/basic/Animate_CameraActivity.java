...
public class Animate_CameraActivity extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		int i = v.getId();
		if (i == R.id.stop_animation) {
			aMap.stopAnimation();

			/**
			 * 点击“去中关村”按钮响应事件
			 */
		} else if (i == R.id.Zhongguancun) {
			changeCamera(
