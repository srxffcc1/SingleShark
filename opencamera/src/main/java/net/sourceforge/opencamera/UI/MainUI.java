...
public class MainUI {
	...
	public MainUI(OpMainActivity main_activity) {
		if( OpDebug.LOG )
			Log.d(TAG, "MainUI");
    ...
    public void closePopup() {
		...
		if( popupIsOpen() ) {
			 ...
			 *     OpMainActivity.updateForSettings(), but doing so makes the popup close when checking photo or video resolutions!
