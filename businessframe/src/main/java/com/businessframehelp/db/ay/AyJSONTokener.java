...
/**
 * Parses a AyJSONUtil (<a href="http://www.ietf.org/rfc/rfc4627.txt">RFC 4627</a>)
 * encoded string into the corresponding object. Most clients of this class will
 * use only need the {@link #AyJSONTokener(String) constructor} and
 ...
 * 
 * JSONObject object = (JSONObject) new AyJSONTokener(json).nextValue();
 * String query = object.getString(&quot;query&quot;);
 * JSONArray locations = object.getJSONArray(&quot;locations&quot;);
 * </pre>
 * 
 * <p>
 * For best interoperability and performance use AyJSONUtil that complies with RFC
 ...
 * string was valid AyJSONUtil. All of the following syntax errors will be ignored:
 * <ul>
 ...
 * 
 * <p>
 * Each tokener may be used to parse a single AyJSONUtil string. Instances of this
 ...
 * information.
 */
public class AyJSONTokener {

	/** The input AyJSONUtil. */
	...
	/**
	 * @param in
	 *            AyJSONUtil encoded string. Null is not permitted and will yield a
	 *            tokener that throws {@code NullPointerExceptions} when methods
	 *            are called.
	 */
	public AyJSONTokener(String in) {
		this.in = in;
	}
	...
	private int nextCleanInternal() throws JSONException {
		...
		while (pos < in.length()) {
			...
			case '#':
				/*
				 * Skip a # hash end-of-line comment. The AyJSONUtil RFC doesn't
	 ...
	 */
	private AyJSONObject readObject() throws JSONException {
		AyJSONObject result = new AyJSONObject();
	 ...
	 * Legacy APIs.
	 * 
	 * None of the methods below are on the critical path of parsing AyJSONUtil
	 ...
	 * for AyJSONUtil strings that contain the character '\0'.
	 */
	public char next() {
	 ...
	 * method is ambiguous for AyJSONUtil strings that contain the character '\0'.
	 */
