...
import com.shark.app.business.view.module.ActivityEnterpriseListOffLine;
...
//            //System.out.println("点击了综合查询");
    ...
    public void buttonSubmit(View view){
        if(TextUtils.isEmpty(isselectchecktext.getText().toString())||TextUtils.isEmpty(beijianchaqiye.getText().toString())){
            ...
            DateBase_Entity zhifabianhao=Demo_DbUtil.getSearchResultOnlyOne(Demo_DBManager.build().search(new Entity_ZhiFaBianHao().setId(bianhaoid)));
            zhifabianhao.put("企业名称",beijianchaqiye.getText().toString());
