...
import com.shark.app.business.adapter.TestRecycleAdapter;

/**
 * Created by Administrator on 2017/5/25.
 */

public class FragmentJoinCheck extends BaseSupportFragment {
    private RecyclerView recycler_view;
    private VRefreshLayout mRefreshLayout;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.include_recyclerefresh,container,false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        recycler_view.setAdapter(new TestRecycleAdapter(this));
