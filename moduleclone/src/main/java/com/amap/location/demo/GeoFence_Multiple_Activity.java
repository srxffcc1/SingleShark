...
public class GeoFence_Multiple_Activity extends CheckPermissionsActivity
	...
	public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.bt_addFence) {
            setRadioGroupAble(false);
            addFence();

        } else if (i == R.id.bt_option) {
	...
	public void onMapClick(LatLng latLng) {
        ...
        int i = rgFenceType.getCheckedRadioButtonId();
        if (i == R.id.rb_roundFence || i == R.id.rb_nearbyFence) {
            centerLatLng = latLng;
        ...
        } else if (i == R.id.rb_polygonFence) {
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		...
		centerLatLng = null;
		btAddFence.setEnabled(true);
        if (checkedId == R.id.rb_roundFence) {
            resetView_round();

        } else if (checkedId == R.id.rb_polygonFence) {
            resetView_polygon();

        } else if (checkedId == R.id.rb_keywordFence) {
            resetView_keyword();

        } else if (checkedId == R.id.rb_nearbyFence) {
            resetView_nearby();

        } else if (checkedId == R.id.rb_districeFence) {
            resetView_district();
	...
	private void addFence() {
        int i = rgFenceType.getCheckedRadioButtonId();
        if (i == R.id.rb_roundFence) {
            addRoundFence();

        } else if (i == R.id.rb_polygonFence) {
            addPolygonFence();

        } else if (i == R.id.rb_keywordFence) {
            addKeywordFence();

        } else if (i == R.id.rb_nearbyFence) {
            addNearbyFence();

        } else if (i == R.id.rb_districeFence) {
            addDistrictFence();
