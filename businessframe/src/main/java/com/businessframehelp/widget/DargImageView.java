...
public class DargImageView extends ImageView implements View.OnTouchListener {
    ...
    public DargImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setOnTouchListener(this);
        initScreenW_H();
    }

    public DargImageView(Context context, AttributeSet attrs) {
...
//                canperform=false;
            ...
            case MotionEvent.ACTION_UP:
                dragDirection = 0;
                if (Math.abs(event.getRawX() - oldx) < 5 && Math.abs(event.getRawY() - oldy) < 5) {
                    canperform=true;
                    performClick();
                }else{
                    canperform=false;
