...
public class ActivityJiHuaList extends AbstractActivitySearchList {
...
//                        StyledDialog.dismissLoading(getActivity());
    ...
    public void toSearchResult(String search) {
        if("".equals(search)){
            ...
            company.clear();
            company.putlogic2value("计划名称","like",search);
...
//            StyledDialog.buildLoading().show();
    ...
    class EnterPriseAdapter extends RecyclerView.Adapter<EnterPriseAdapter.SingelViewHolder>{
        ...
        public SingelViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView=LayoutInflater.from(getBaseContext()).inflate(R.layout.item_jihualist,parent,false);
        ...
        public void onBindViewHolder(SingelViewHolder holder, int position) {
            ...
            holder.jhmc.setText(enterprise.getValue("计划名称"));
            holder.jhfzr.setText("计划负责人:"+(enterprise.getValue("计划负责人")+"").replace("null",""));
            holder.jhcy.setText("计划成员:"+(enterprise.getValue("计划成员")+"").replace("null",""));
            holder.jhwcsj.setText("计划完成时间:"+(enterprise.getValue("计划完成时间")+"").replace("null",""));
            holder.jhid=enterprise.getId();
            holder.jhmcs=enterprise.getValue("计划名称");
            holder.jhfzrs=enterprise.getValue("计划负责人");
            holder.jhcys=enterprise.getValue("计划成员");
            holder.jhwcsjs=enterprise.getValue("计划完成时间");
        }
        ...
        public class SingelViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener {
            public TextView jhmc;
            public TextView jhfzr;
            public TextView jhcy;
            public TextView jhwcsj;
            public String jhid;
            public String jhmcs;
            public String jhfzrs;
            public String jhcys;
            public String jhwcsjs;
            public SingelViewHolder(View itemView) {
                super(itemView);
                jhmc= (TextView) itemView.findViewById(R.id.jhmc);
                jhfzr= (TextView) itemView.findViewById(R.id.jhfzr);
                jhcy= (TextView) itemView.findViewById(R.id.jhcy);
                jhwcsj=(TextView) itemView.findViewById(R.id.jhwcsj);
...
//                    startActivity(new Intent(getBaseContext(),ActivityEnterpriseDetailOff.class).putExtra("jhid",jhid));
                }else{
                    Intent intent=new Intent()
                            .putExtra("jhid",jhid)
                            .putExtra("jhmc",jhmcs)
                            .putExtra("jhfzr",jhfzrs)
                            .putExtra("jhcy",jhcys)
                            .putExtra("jhwcsj",jhwcsjs);
