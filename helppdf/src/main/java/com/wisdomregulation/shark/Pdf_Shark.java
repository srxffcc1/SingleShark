...
import com.wisdomregulation.pdflink.IPdf_Back;
import com.wisdomregulation.pdflink.IPdf_BackFrame;
import com.wisdomregulation.pdflink.ImageBuilder;
import com.wisdomregulation.pdflink.Pdf_Format;
...
public class Pdf_Shark {
    ...
    private static final Pdf_Shark pdfhelp=new Pdf_Shark();
    ...
    public Pdf_Shark setCity(String city) {
        Pdf_Shark.city = city;
        return this;
    }
     ...
     * @return
     */
    public Pdf_Shark setFileout(String fileout) {
     ...
     * @return
     */
    public static Pdf_Shark create() {
        return pdfhelp;
    }
    ...
    public Pdf_Shark setListener(DownLoaderTask.DownLoaderListener listener) {
     ...
     * @return
     */
    public Pdf_Shark setTTFpath(String simdir) {
        try {
...
//                }
                ...
                fontChineseNormalsimfang12 = FontFactory.getFont("com/itextpdf/text/pdf/fonts/simfang.ttf",BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED, 12, Font.NORMAL,
                        BaseColor.BLACK);
                fontChineseBoldsimfang16 = FontFactory.getFont("com/itextpdf/text/pdf/fonts/simfang.ttf",BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED, 16, Font.BOLD,
                        BaseColor.BLACK);

                fontChineseBoldsimhei15 = FontFactory.getFont("com/itextpdf/text/pdf/fonts/simhei.ttf",BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED, 15, Font.BOLD,
                        BaseColor.BLACK);
                fontChineseBoldsimhei19 = FontFactory.getFont("com/itextpdf/text/pdf/fonts/simhei.ttf",BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED, 19, Font.NORMAL,
                        BaseColor.BLACK);
                fontChineseBoldsimhei17 = FontFactory.getFont("com/itextpdf/text/pdf/fonts/simhei.ttf",BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED, 17, Font.NORMAL,
                        BaseColor.BLACK);
                fontChineseBoldsimhei20 = FontFactory.getFont("com/itextpdf/text/pdf/fonts/simhei.ttf",BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED, 20, Font.BOLD,
                        BaseColor.BLACK);
            }
    ...
    public Pdf_Shark close() {
        try {
                    ...
                    for (int i = 0; i < tmpbooklist.size(); i++) {
                        ...
                        try {
                            Method printm = Pdf_Shark.this.getClass().getDeclaredMethod("printer" + book.getClass().getSimpleName(), Base_Entity.class, Object.class);
                            printm.setAccessible(true);
                            printm.invoke(Pdf_Shark.this, book, image);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
     ...
     * @return
     */
    public Pdf_Shark close(final IPdf_Back back) {
        try {
    ...
    public Pdf_Shark printerMaster(final Base_Entity book, final Object image) {
...
//            }
    ...
    public Pdf_Shark printerMaster(final Base_Entity book) {
        if (!canprinter) {
            return this;
        } else {
...
//				try {
//					resulttime = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss")
...
//				}
    ...
    public void printFrameWork(final Base_Entity book, final Object image, IPdf_BackFrame pdf_backframe) {
        try {
            if (space1 == null) {
    ...
    public void printerContinue(final Base_Entity book, final Object image, final IPdf_Back pdf_back, final int newpagelength) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            @Override
    ...
    public void printerEntity_Book0(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                rowCell1P.add(Pdf_Format.tablenounderLine(
                ...
                rowCell2P1.add(Pdf_Format.tablenounderLine(
                        book.getValue(13), 360, fontChineseNormalsimfang12));
                toMeasurefloat(rowCell2P1);
                rowCell2P2.add(new Chunk("承办人（签名）：", fontChineseNormalsimfang12));
                rowCell2P2.add(Pdf_Format.tableunderLine(
                        book.getValue(14), 72, fontChineseNormalsimfang12));
                rowCell2P2.add(new Chunk("证号：", fontChineseNormalsimfang12));
                rowCell2P2.add(Pdf_Format.tableunderLine(
                        book.getValue(15), 72, fontChineseNormalsimfang12));
                rowCell2P2.add(Pdf_Format.tablenounderLine("", 276,
                        fontChineseNormalsimfang12));
                toMeasurefloat(rowCell2P2);

                rowCell2P3.add(Pdf_Format.tablenounderLine("", 108,
                        fontChineseNormalsimfang12));
                rowCell2P3.add(Pdf_Format.tableunderLine(
                        book.getValue(16), 72, fontChineseNormalsimfang12));
                rowCell2P3.add(new Chunk("证号：", fontChineseNormalsimfang12));
                rowCell2P3.add(Pdf_Format.tableunderLine(
                        book.getValue(17), 72, fontChineseNormalsimfang12));
                rowCell2P3.add(Pdf_Format.tablenounderLine("", 42,
                        fontChineseNormalsimfang12));
                rowCell2P3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 0), 36,
                        fontChineseNormalsimfang12));
                rowCell2P3.add(new Chunk("年", fontChineseNormalsimfang12));
                rowCell2P3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 1), 36,
                        fontChineseNormalsimfang12));
                rowCell2P3.add(new Chunk("月", fontChineseNormalsimfang12));
                rowCell2P3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                rowCell3P1.add(Pdf_Format.tablenounderLine(book.getValue(19), 648,
                        fontChineseNormalsimfang12));
                toMeasurefloat(rowCell3P1);
                toMeasurefloat(rowCell3P2);

                rowCell3P3.add(Pdf_Format.tablenounderLine("    ",
                        60, fontChineseNormalsimfang12));
                rowCell3P3.add(new Chunk("审核人（签名）：", fontChineseNormalsimfang12));
                rowCell3P3.add(Pdf_Format.tablenounderLine(book.getValue(20), 60,
                        fontChineseNormalsimfang12));
                rowCell3P3.add(Pdf_Format.tablenounderLine("    ",
                        120, fontChineseNormalsimfang12));
                toMeasurefloat(rowCell3P3);
                rowCell3P4.add(Pdf_Format.tablenounderLine("    ",
                        60, fontChineseNormalsimfang12));
                rowCell3P4.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 0), 36,
                        fontChineseNormalsimfang12));
                rowCell3P4.add(new Chunk("年", fontChineseNormalsimfang12));
                rowCell3P4.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 1), 36,
                        fontChineseNormalsimfang12));
                rowCell3P4.add(new Chunk("月", fontChineseNormalsimfang12));
                rowCell3P4.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                rowCell4P1.add(Pdf_Format.tablenounderLine(book.getValue(22), 648,
                        fontChineseNormalsimfang12));
                toMeasurefloat(rowCell4P1);
                toMeasurefloat(rowCell4P2);

                rowCell4P3.add(Pdf_Format.tablenounderLine("    ",
                        60, fontChineseNormalsimfang12));
                rowCell4P3.add(new Chunk("审批人（签名）：", fontChineseNormalsimfang12));
                rowCell4P3.add(Pdf_Format.tablenounderLine(book.getValue(23), 60,
                        fontChineseNormalsimfang12));
                rowCell4P3.add(Pdf_Format.tablenounderLine("   ",
                        120, fontChineseNormalsimfang12));
                toMeasurefloat(rowCell4P3);
                rowCell4P4.add(Pdf_Format.tablenounderLine("   ",
                        60, fontChineseNormalsimfang12));
                rowCell4P4.add(Pdf_Format.tablenounderLine(getTime(book.getValue(24), 0), 36,
                        fontChineseNormalsimfang12));
                rowCell4P4.add(new Chunk("年", fontChineseNormalsimfang12));
                rowCell4P4.add(Pdf_Format.tablenounderLine(getTime(book.getValue(24), 1), 36,
                        fontChineseNormalsimfang12));
                rowCell4P4.add(new Chunk("月", fontChineseNormalsimfang12));
                rowCell4P4.add(Pdf_Format.tablenounderLine(getTime(book.getValue(24), 2), 36,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book1(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase1 = new Phrase();
                phrase1.add((Pdf_Format.underLine(book.getValue(3), 192,
                        fontChineseNormalsimfang12)));
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(4), 348,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase3 = new Phrase();
                phrase3.add(Pdf_Format.underLine(getTime(book.getValue(5), 0), 24,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(getTime(book.getValue(5), 1), 24,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(getTime(book.getValue(5), 2), 24,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(getTime(book.getValue(5), 3), 24,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("时到", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(6), 168,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase8 = new Phrase(Pdf_Format.underLine(book.getValue(8), 1704,
                        fontChineseNormalsimfang12));
                ...
                phrase10.add(Pdf_Format.underLine(book.getValue(9), 252,
                        fontChineseNormalsimfang12));
                ...
                phrase11.add(Pdf_Format.underLine(book.getValue(10), 102,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("联系电话：", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.underLine(book.getValue(11), 198,
                        fontChineseNormalsimfang12));
                ...
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 0), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 1), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 2), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.tablenounderLine("", 36,
                        fontChineseNormalsimfang12));
                ...
                RadioCheckField bt = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(102, 548, 10), "Yes260",
                ...
                RadioCheckField bt2 = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(102, 524, 10), "Yes149",
                ...
                RadioCheckField bt3 = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(102, 500, 10), "Yes57", getCheck(book.getValue(7), 3));
                ...
                RadioCheckField bt4 = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(102, 476, 10), "Yes318",
    ...
    public void printerEntity_Book2(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 0), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 1), 18, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 2), 12, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 3), 12, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 4), 12, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("分至", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 2), 12, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 3), 12, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 4), 12, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("分", fontChineseNormalsimfang12));

                phrase1.add(Pdf_Format.tablenounderLine("", 60,
                        fontChineseNormalsimfang12));
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(6), 348,
                        fontChineseNormalsimfang12));

                Phrase phrase3 = new Phrase();
                phrase3.add(new Chunk("被询问人姓名：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                ...
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(10), 98, fontChineseNormalsimfang12));

                Phrase phrase4 = new Phrase();
                phrase4.add(new Chunk("工作单位：", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(11), 240,
                        fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph3 = new Paragraph();
                paragraph3.setFirstLineIndent(84f);
                paragraph3.setLeading(24f);
                paragraph3.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase14 = new Phrase();
                // phrase14.add(new Chunk("询问记录：", fontChineseKNormal));
                phrase14.add(Pdf_Format.underLine(book.getValue(26), 3372,
                        fontChineseNormalsimfang12));
                ...
                phrase15.add(Pdf_Format.tablenounderLine(book.getValue(27), 120,
                        fontChineseNormalsimfang12));
                phrase15.add(new Chunk("记录人（签名）：", fontChineseNormalsimfang12));
                phrase15.add(Pdf_Format.tablenounderLine(book.getValue(28), 114,
                        fontChineseNormalsimfang12));

                Phrase phrase16 = new Phrase();
                phrase16.add(new Chunk("被询问人（签名）：", fontChineseNormalsimfang12));
                phrase16.add(Pdf_Format.tablenounderLine(book.getValue(29), 156,
                        fontChineseNormalsimfang12));
                phrase16.add(Pdf_Format.tablenounderLine(getTime(book.getValue(30), 0), 36,
                        fontChineseNormalsimfang12));
                phrase16.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase16.add(Pdf_Format.tablenounderLine(getTime(book.getValue(30), 1), 36,
                        fontChineseNormalsimfang12));
                phrase16.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase16.add(Pdf_Format.tablenounderLine(getTime(book.getValue(30), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                phrase17.add(Pdf_Format.tablenounderLine("", 336,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book3(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 0), 72, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 1), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 2), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 3), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 4), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("分至", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 2), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 3), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 4), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("分", fontChineseNormalsimfang12));

                Phrase phrase2 = new Phrase();
                phrase2.add(new Chunk("勘验场所：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 180,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("天气情况：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(6), 108,
                        fontChineseNormalsimfang12));
                ...
                phrase3.add(Pdf_Format.underLine(book.getValue(8), 204,
                        fontChineseNormalsimfang12));
                ...
                phrase4.add(Pdf_Format.underLine(book.getValue(10), 204,
                        fontChineseNormalsimfang12));
                ...
                phrase5.add(Pdf_Format.underLine(book.getValue(12), 204,
                        fontChineseNormalsimfang12));
                ...
                phrase6.add(new Chunk("单位及职务：", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(14), 204,
                        fontChineseNormalsimfang12));
                ...
                phrase7.add(new Chunk("单位及职务：", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.underLine(book.getValue(16), 204,
                        fontChineseNormalsimfang12));

                Phrase phrase8 = new Phrase();
                phrase8.add(new Chunk("记录人：", fontChineseNormalsimfang12));
                phrase8.add(Pdf_Format
                        .underLine(book.getValue(17), 84, fontChineseNormalsimfang12));
                phrase8.add(new Chunk("单位及职务：", fontChineseNormalsimfang12));
                phrase8.add(Pdf_Format.underLine(book.getValue(18), 204,
                        fontChineseNormalsimfang12));
                ...
                phrase9.add(Pdf_Format
                        .underLine(book.getValue(20), 48, fontChineseNormalsimfang12));
                phrase9.add(new Chunk("、", fontChineseNormalsimfang12));
                phrase9.add(Pdf_Format
                        .underLine(book.getValue(21), 48, fontChineseNormalsimfang12));
                phrase9.add(new Chunk("，", fontChineseNormalsimfang12));
                ...
                phrase10.add(Pdf_Format.underLine(book.getValue(22), 60,
                        fontChineseNormalsimfang12));
                phrase10.add(new Chunk("、", fontChineseNormalsimfang12));
                phrase10.add(Pdf_Format.underLine(book.getValue(23), 60,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase12 = new Phrase();
                // phrase12.add(new Chunk("勘验情况：", fontChineseKNormal));
                phrase12.add(Pdf_Format.underLine(book.getValue(24), 3804,
                        fontChineseNormalsimfang12));
                ...
                phrase13.add(Pdf_Format.underLine(book.getValue(25), 102,
                        fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("勘验人（签名）：", fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.underLine(book.getValue(26), 102,
                        fontChineseNormalsimfang12));

                Phrase phrase14 = new Phrase();
                phrase14.add(new Chunk("当事人（签名）：", fontChineseNormalsimfang12));
                phrase14.add(Pdf_Format.underLine(book.getValue(27), 96,
                        fontChineseNormalsimfang12));
                phrase14.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase14.add(new Chunk("联系方式：", fontChineseNormalsimfang12));
                phrase14.add(Pdf_Format.underLine(book.getValue(28), 144,
                        fontChineseNormalsimfang12));

                Phrase phrase15 = new Phrase();
                phrase15.add(new Chunk("当事人（签名）：", fontChineseNormalsimfang12));
                phrase15.add(Pdf_Format.underLine(book.getValue(29), 96,
                        fontChineseNormalsimfang12));
                phrase15.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase15.add(new Chunk("联系方式：", fontChineseNormalsimfang12));
                phrase15.add(Pdf_Format.underLine(book.getValue(30), 144,
                        fontChineseNormalsimfang12));

                Phrase phrase16 = new Phrase();
                phrase16.add(new Chunk("被邀请人（签名）：", fontChineseNormalsimfang12));
                phrase16.add(Pdf_Format.underLine(book.getValue(31), 84,
                        fontChineseNormalsimfang12));
                phrase16.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase16.add(new Chunk("联系方式：", fontChineseNormalsimfang12));
                phrase16.add(Pdf_Format.underLine(book.getValue(32), 132,
                        fontChineseNormalsimfang12));
                ...
                phrase17.add(new Chunk("本页填写不下的内容或需绘制勘验图的，可另附页。",
                        fontChineseNormalsimfang12));
                phrase17.add(Pdf_Format.tablenounderLine("", 48,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book4(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(Pdf_Format.underLine(book.getValue(3), 144,
                        fontChineseNormalsimfang12));
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 108,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("联系电话：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(book.getValue(6), 60, fontChineseNormalsimfang12));
                ...
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(8), 0), 48, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(8), 1), 24, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(8), 2), 24, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(8), 3), 24, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(8), 4), 24, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("分至", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 2), 24, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 3), 24, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 4), 24, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("分", fontChineseNormalsimfang12));

                Phrase phrase4 = new Phrase();
                phrase4.add(new Chunk("抽样地点：", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(10), 348,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase8 = new Phrase();
                phrase8.add(Pdf_Format.tablenounderLine("", 192,
                        fontChineseNormalsimfang12));
                phrase8.add(Pdf_Format
                ...
                Phrase phrase10 = new Phrase();
                phrase10.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 0), 36,
                        fontChineseNormalsimfang12));
                phrase10.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase10.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 1), 36,
                        fontChineseNormalsimfang12));
                phrase10.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase10.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 2), 36,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book5(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase02p0.add(Pdf_Format.tablenounderLine(book.getValue(4), 744, fontChineseNormalsimfang12));
                ...
                phrase12p0.add(Pdf_Format.tablenounderLine(book.getValue(5), 1488, fontChineseNormalsimfang12));
                ...
                phrase22p0.add(Pdf_Format.tablenounderLine(book.getValue(6), 744, fontChineseNormalsimfang12));
                ...
                phrase32p0.add(Pdf_Format.tablenounderLine(book.getValue(7), 1116, fontChineseNormalsimfang12));
                ...
                phrase42p0.add(Pdf_Format.tablenounderLine(book.getValue(8), 372, fontChineseNormalsimfang12));
                ...
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(9), 180,
                        fontChineseNormalsimfang12));

                Phrase phrase3 = new Phrase();
                phrase3.add(new Chunk("承办人（签名）：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(10), 204,
                        fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(11), 0), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(11), 1), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(11), 2), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("日", fontChineseNormalsimfang12));
                ...
                phrase4.add(Pdf_Format.tablenounderLine(book.getValue(12), 180,
                        fontChineseNormalsimfang12));

                Phrase phrase5 = new Phrase();
                phrase5.add(new Chunk("负责人（签名）：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(book.getValue(13), 204,
                        fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(14), 0), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(14), 1), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(14), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                phrase6.add(Pdf_Format.tablenounderLine(book.getValue(15), 180,
                        fontChineseNormalsimfang12));

                Phrase phrase7 = new Phrase();
                phrase7.add(new Chunk("负责人（签名）：", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(book.getValue(16), 204,
                        fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 0), 36,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 1), 36,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 2), 36,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book6(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase1 = new Phrase();
                phrase1.add((Pdf_Format.underLine(book.getValue(3), 216,
                        fontChineseNormalsimfang12)));
                phrase1.add(new Chunk(":", fontChineseNormalsimfang12));
                toMeasurefloat(phrase1);
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(4), 264,
                        fontChineseNormalsimfang12));
                ...
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(5), 0), 60, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(5), 1), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(5), 2), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("日到", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(6), 192,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase9 = new Phrase();
                phrase9.add(Pdf_Format.tablenounderLine(getTime(book.getValue(8), 0), 36,
                        fontChineseNormalsimfang12));
                phrase9.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase9.add(Pdf_Format.tablenounderLine(getTime(book.getValue(8), 1), 36,
                        fontChineseNormalsimfang12));
                phrase9.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase9.add(Pdf_Format.tablenounderLine(getTime(book.getValue(8), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                phrase10.add(Pdf_Format.underLine(book.getValue(7), 84,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book7(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase22p0 = new Phrase();
                phrase22p0.add(Pdf_Format.tablenounderLine(book.getValue(6), 1116, fontChineseNormalsimfang12));
                lin22p0.add(phrase22p0);
                ...
                Phrase phrase2 = new Phrase();
                phrase2.add(new Chunk("承办人意见：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(8), 180,
                        fontChineseNormalsimfang12));

                Phrase phrase3 = new Phrase();
                phrase3.add(new Chunk("承办人（签名）：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(9), 192,
                        fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 0), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 1), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 2), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("日", fontChineseNormalsimfang12));
                ...
                Phrase phrase4 = new Phrase();
                phrase4.add(new Chunk("部门负责人意见：", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.tablenounderLine(book.getValue(11), 180,
                        fontChineseNormalsimfang12));

                Phrase phrase5 = new Phrase();
                phrase5.add(new Chunk("负责人（签名）：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(book.getValue(12), 192,
                        fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 0), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 1), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 2), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("日", fontChineseNormalsimfang12));
                ...
                Phrase phrase6 = new Phrase();
                phrase6.add(new Chunk("机关负责人意见：", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.tablenounderLine(book.getValue(14), 180,
                        fontChineseNormalsimfang12));

                Phrase phrase7 = new Phrase();
                phrase7.add(new Chunk("负责人（签名）：", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(book.getValue(15), 192,
                        fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(16), 0), 36,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(16), 1), 36,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(16), 2), 36,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("日", fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book8(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase1 = new Phrase();
                phrase1.add((Pdf_Format.underLine(book.getValue(2), 192,
                        fontChineseNormalsimfang12)));
                phrase1.add(new Chunk(":", fontChineseNormalsimfang12));
                toMeasurefloat(phrase1);
                ...
                final Paragraph paragraph1 = new Paragraph();
                paragraph1.setFirstLineIndent(336f);
                paragraph1.setLeading(24f);
                paragraph1.setAlignment(Element.ALIGN_LEFT);
                ...
                paragraph1_2.setFirstLineIndent(156f);
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 972,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("等物品进行了先行登记保存[文号:", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine("", 12,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("（", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(book.getValue(6), 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("）安监管先保通〔", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(book.getValue(7), 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("〕", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(book.getValue(8), 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("号]。现依法", fontChineseNormalsimfang12));

                // phrase2_1.add(new Chunk("对上述物品作出如下处理：", fontChineseKNormal));

                phrase2_2.add(Pdf_Format.underLine(book.getValue(9), 3744,
                        fontChineseNormalsimfang12));
                ...
                phrase3.add(Pdf_Format.underLine(book.getValue(10), 156,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("人民政府或者", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(11), 108,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("申请行政复议，或者在三个月内依法向", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(12), 96, fontChineseNormalsimfang12));
                ...
                phrase22.add(Pdf_Format.underLine(getTime(book.getValue(4), 0), 60,
                        fontChineseNormalsimfang12));
                phrase22.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase22.add(Pdf_Format.underLine(getTime(book.getValue(4), 1), 36,
                        fontChineseNormalsimfang12));
                phrase22.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase22.add(Pdf_Format.underLine(getTime(book.getValue(4), 2), 36,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book9(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(Pdf_Format.underLine(book.getValue(3), 330,
                        fontChineseNormalsimfang12));

                Phrase phrase2 = new Phrase();
                phrase2.add(new Chunk("地  址：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(4), 360,
                        fontChineseNormalsimfang12));

                Phrase phrase3 = new Phrase();
                phrase3.add(new Chunk("法定代表人（负责人）：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(5), 60, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("职务：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(6), 60, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("联系电话：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(7), 60, fontChineseNormalsimfang12));

                Phrase phrase4 = new Phrase();
                phrase4.add(new Chunk("检查场所：", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(8), 348,
                        fontChineseNormalsimfang12));

                Phrase phrase5 = new Phrase();
                phrase5.add(new Chunk("检查时间：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 0), 24, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 1), 24, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 2), 24, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("日", fontChineseNormalsimfang12));
                ...
                phrase5.add(Pdf_Format
                        .underLine(getTime(book.getValue(10), 2), 24, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(getTime(book.getValue(10), 3), 24, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(getTime(book.getValue(10), 4), 24, fontChineseNormalsimfang12));
                ...
                Phrase phrase8 = new Phrase();
                // phrase8.add(new Chunk("检查情况：", fontChineseKNormal));
                phrase8.add(Pdf_Format.underLine(book.getValue(16), 5532,
                        fontChineseNormalsimfang12));
                ...
                phrase9.add("\n");
                phrase9.add(Pdf_Format.tablenounderLine("", 264,
                        fontChineseNormalsimfang12));
                phrase9.add(Pdf_Format.tablenounderLine(getTime(book.getValue(20), 0), 36,
                        fontChineseNormalsimfang12));
                phrase9.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase9.add(Pdf_Format.tablenounderLine(getTime(book.getValue(20), 1), 36,
                        fontChineseNormalsimfang12));
                phrase9.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase9.add(Pdf_Format.tablenounderLine(getTime(book.getValue(20), 2), 36,
                        fontChineseNormalsimfang12));
                phrase9.add(new Chunk("日", fontChineseNormalsimfang12));
                ...
                phrase17.add(Pdf_Format.tablenounderLine("", 288,
                        fontChineseNormalsimfang12));
                // phrase17.add(new Chunk("共",fontChineseKNormal));
    ...
    public void printerEntity_Book10(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 0), 60, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 1), 60, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 2), 60, fontChineseNormalsimfang12));
                ...
                Phrase phrase3 = new Phrase();
                phrase3.add(Pdf_Format.underLine("1." + book.getValue(5), 394,
                        fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine("；", 0, fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine("2." + book.getValue(6), 394,
                        fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine("；", 1, fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine("3." + book.getValue(7), 262,
                        fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine("。", 1, fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph3 = new Paragraph();
                paragraph3.setFirstLineIndent(240f);
                paragraph3.setLeading(24f);
                paragraph3.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase4 = new Phrase();
                // phrase4.add(new Chunk("以上存在的问题无法保证安全生产，依据", fontChineseKNormal));
                phrase4.add(Pdf_Format.underLine(book.getValue(8), 492,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase5 = new Phrase();
                phrase5.add(Pdf_Format.underLine("1." + book.getValue(9), 394,
                        fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine("；", 0, fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine("2." + book.getValue(10), 394,
                        fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine("；", 1, fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine("3." + book.getValue(11), 262,
                        fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine("。", 1, fontChineseNormalsimfang12));
                ...
                phrase6.add(Pdf_Format.underLine(book.getValue(12), 126,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("人民政府或者", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(13), 126,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("申请行政复议，或者在三个月内依法向", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(14), 102,
                        fontChineseNormalsimfang12));
                ...
                phrase7.add("\n");
                phrase7.add(Pdf_Format.tablenounderLine("", 192,
                        fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format
                        .underLine(book.getValue(17), 84, fontChineseNormalsimfang12));
                phrase7.add(new Chunk("证号：", fontChineseNormalsimfang12));
                ...
                phrase10.add(new Chunk("本文书一式两份：一份由安全生产监督管理部门备案，一份交被检查单位。",
                        fontChineseNormalsimfang12));
                phrase10.add(Pdf_Format.tablenounderLine("", 2,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book11(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase3 = new Phrase();
                phrase3.add(Pdf_Format.underLine("1." + book.getValue(4), 840,
                        fontChineseNormalsimfang12));
                toMeasurefloat(phrase3);
                ...
                Phrase phrase4 = new Phrase();
                phrase4.add(Pdf_Format.underLine("2." + book.getValue(5), 840,
                        fontChineseNormalsimfang12));
                toMeasurefloat(phrase4);
                ...
                Phrase phrase5 = new Phrase();
                phrase5.add(Pdf_Format.underLine("3." + book.getValue(6), 840,
                        fontChineseNormalsimfang12));
                toMeasurefloat(phrase5);
                ...
                Phrase phrase6 = new Phrase();
                phrase6.add(Pdf_Format.underLine("4." + book.getValue(7), 840,
                        fontChineseNormalsimfang12));
                toMeasurefloat(phrase6);
                ...
                phrase7.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 0), 36, fontChineseNormalsimfang12));
                phrase7.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 1), 36, fontChineseNormalsimfang12));
                phrase7.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format
                        .underLine(getTime(book.getValue(9), 2), 36, fontChineseNormalsimfang12));
                ...
                phrase8.add(Pdf_Format.underLine(book.getValue(10), 132,
                        fontChineseNormalsimfang12));
                phrase8.add(new Chunk("人民政府或者", fontChineseNormalsimfang12));
                phrase8.add(Pdf_Format.underLine(book.getValue(11), 108,
                        fontChineseNormalsimfang12));
                phrase8.add(new Chunk("申请行政复议，或者在三个月内依法向", fontChineseNormalsimfang12));
                phrase8.add(Pdf_Format.underLine(book.getValue(12), 120,
                        fontChineseNormalsimfang12));
                ...
                phrase9.add("\n");
                phrase9.add(Pdf_Format.tablenounderLine("", 196,
                        fontChineseNormalsimfang12));
                phrase9.add(Pdf_Format
                        .underLine(book.getValue(15), 84, fontChineseNormalsimfang12));
                phrase9.add(new Chunk("证号：", fontChineseNormalsimfang12));
                ...
                phrase9.add(Pdf_Format.underLine(book.getValue(17), 102,
                        fontChineseNormalsimfang12));
                paragraph8.add(phrase9);
                ...
                Phrase phrase11 = new Phrase();
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 0), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 1), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                if (!book.getValue("续页").equals("")) {
                    printerContinue(book, image, new IPdf_Back() {
                        @Override
    ...
    public void printerEntity_Book12(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 0), 36, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 1), 36, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 2), 36, fontChineseNormalsimfang12));
                ...
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(6), 36,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk(")安监管", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(book.getValue(7), 36, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("〔", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(8), 36,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("〕", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(9), 36,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("号]，经对你单位整改情况进行复查，提出如下意见：",
                        fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(10), 3888,
                        fontChineseNormalsimfang12));
                ...
                phrase9.add(Pdf_Format
                        .underLine(book.getValue(13), 84, fontChineseNormalsimfang12));
                phrase9.add("\n");
                phrase9.add(Pdf_Format.tablenounderLine("", 192,
                        fontChineseNormalsimfang12));
                phrase9.add(Pdf_Format
                        .underLine(book.getValue(14), 84, fontChineseNormalsimfang12));
                phrase9.add(new Chunk("证号：", fontChineseNormalsimfang12));
                ...
                Phrase phrase11 = new Phrase();
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(16), 0), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(16), 1), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(16), 2), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase11);
    ...
    public void printerEntity_Book13(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                final Paragraph paragraph1 = new Paragraph();
                paragraph1.setFirstLineIndent(324f);
                paragraph1.setLeading(24f);
                paragraph1.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase2 = new Phrase();
                // phrase2.add(new
                // Chunk("我局在现场检查时，发现你单位（现场）存在下列问题：",fontChineseKNormal));
                phrase2.add(Pdf_Format.underLine(book.getValue(4), 2700,
                        fontChineseNormalsimfang12));
                toMeasurefloat(phrase2);
                ...
                final Paragraph paragraph2 = new Paragraph();
                paragraph2.setFirstLineIndent(240f);
                paragraph2.setLeading(24f);
                paragraph2.setAlignment(Element.ALIGN_LEFT);

                final Paragraph paragraph2_1 = new Paragraph();
                paragraph2_1.setFirstLineIndent(132f);
                paragraph2_1.setLeading(24f);
                paragraph2_1.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase3 = new Phrase();
                Phrase phrase3_1 = new Phrase();
                // phrase3.add(new Chunk("以上存在的问题无法保障安全生产，依据", fontChineseKNormal));
                phrase3.add(Pdf_Format.underLine(book.getValue(5), 612,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("，", fontChineseNormalsimfang12));
                // phrase3.add(new Chunk("决定采取以下强制措施：", fontChineseKNormal));
                phrase3_1.add(Pdf_Format.underLine(book.getValue(6), 1596,
                        fontChineseNormalsimfang12));
                toMeasurefloat(phrase3);
                ...
                phrase4.add(Pdf_Format.underLine(book.getValue(7), 132,
                        fontChineseNormalsimfang12));
                phrase4.add(new Chunk("人民政府或者", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(8), 120,
                        fontChineseNormalsimfang12));
                phrase4.add(new Chunk("申请行政复议，或者在三个月内依法向", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(9), 108,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase6 = new Phrase();
                phrase6.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 0), 36,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 1), 36,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 2), 36,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book14(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase2 = new Phrase();
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 1728,
                        fontChineseNormalsimfang12));
                ...
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(6), 0), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(6), 1), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(6), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase6 = new Phrase();
                phrase6.add(Pdf_Format.tablenounderLine(getTime(book.getValue(7), 0), 36,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.tablenounderLine(getTime(book.getValue(7), 1), 36,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.tablenounderLine(getTime(book.getValue(7), 2), 36,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase6);
    ...
    public void printerEntity_Book15(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase1 = new Phrase();
                phrase1.add((Pdf_Format.underLine(book.getValue(3), 108,
                        fontChineseNormalsimfang12)));
                phrase1.add(new Chunk(":", fontChineseNormalsimfang12));
                toMeasurefloat(phrase1);
                ...
                final Paragraph paragraph1 = new Paragraph();
                paragraph1.setFirstLineIndent(132f);
                paragraph1.setLeading(24f);
                paragraph1.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase2 = new Phrase();
                // phrase2.add(new Chunk("经查，你（单位）有",fontChineseKNormal));
                phrase2.add(Pdf_Format.underLine(book.getValue(4), 2856,
                        fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph2 = new Paragraph();
                paragraph2.setFirstLineIndent(108f);
                paragraph2.setLeading(24f);
                paragraph2.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase3 = new Phrase();

                // phrase3.add(new Chunk("以上行为违反了", fontChineseKNormal));
                phrase3.add(Pdf_Format.underLine(book.getValue(5), 1188,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("的规定，依据", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(6), 360,
                        fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine("，", 0, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("拟对你（单位）作出", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(7), 324,
                        fontChineseNormalsimfang12));
                ...
                phrase5.add(Pdf_Format.underLine(book.getValue(9), 252,
                        fontChineseNormalsimfang12));
                phrase5.add("\n");
                phrase5.add(new Chunk("联系人：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(book.getValue(10), 88, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("联系电话：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(book.getValue(11), 88, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("邮编：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(book.getValue(12), 88, fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph5 = new Paragraph();
                paragraph5.setFirstLineIndent(216f);
                paragraph5.setLeading(24f);
                paragraph4.setAlignment(Element.ALIGN_LEFT);
                ...
                Phrase phrase7 = new Phrase();
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 0), 36,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 1), 36,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 2), 36,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase7);
    ...
    public void printerEntity_Book16(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 0), 48, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(3), 1), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("月", fontChineseNormalsimfang12));
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 372,
                        fontChineseNormalsimfang12));

                Phrase phrase3 = new Phrase();
                phrase3.add(new Chunk("陈述申辩人：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(6), 102,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("性别：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(7), 60, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("职务：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(8), 102,
                        fontChineseNormalsimfang12));
                phrase3.add("\n");

                Phrase phrase4 = new Phrase();
                phrase4.add(new Chunk("工作单位：", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(9), 210,
                        fontChineseNormalsimfang12));
                phrase4.add(new Chunk("电话：", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(10), 102,
                        fontChineseNormalsimfang12));
                phrase4.add("\n");

                Phrase phrase5 = new Phrase();
                phrase5.add(new Chunk("联系地址：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine(book.getValue(11), 210,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("邮编：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine(book.getValue(12), 102,
                        fontChineseNormalsimfang12));
                phrase5.add("\n");

                Phrase phrase6 = new Phrase();
                phrase6.add(new Chunk("承办人：", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(13), 222,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("记录人：", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format
                        .underLine(book.getValue(14), 90, fontChineseNormalsimfang12));
                ...
                phrase8.add(Pdf_Format
                        .underLine(book.getValue(18), 90, fontChineseNormalsimfang12));
                phrase8.add(new Chunk("、", fontChineseNormalsimfang12));
                phrase8.add(Pdf_Format
                        .underLine(book.getValue(19), 90, fontChineseNormalsimfang12));
                phrase8.add(new Chunk("，这是我们的证件（出示证件）。现对", fontChineseNormalsimfang12));

                Phrase phrase9 = new Phrase();
                phrase9.add(Pdf_Format.underLine(book.getValue(20), 252,
                        fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph3 = new Paragraph();
                paragraph3.setFirstLineIndent(108f);
                paragraph3.setLeading(24f);
                paragraph3.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase10 = new Phrase();
                // phrase10.add(new Chunk("陈述申辩记录：", fontChineseKNormal));
                phrase10.add(Pdf_Format.underLine(book.getValue(21), 5508,
                        fontChineseNormalsimfang12));
                ...
                phrase11.add(Pdf_Format.underLine(book.getValue(22), 84,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("\n承办人（签名）：", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.underLine(book.getValue(23), 102,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("\n记录人（签名）：", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.underLine(book.getValue(24), 102,
                        fontChineseNormalsimfang12));

                Phrase phrase12 = new Phrase();
                phrase12.add(Pdf_Format.tablenounderLine("", 498,
                        fontChineseNormalsimfang12));
                phrase12.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 0), 36,
                        fontChineseNormalsimfang12));
                phrase12.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase12.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 1), 36,
                        fontChineseNormalsimfang12));
                phrase12.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase12.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 2), 36,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book17(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                final Paragraph paragraph1 = new Paragraph();
                paragraph1.setFirstLineIndent(144f);
                paragraph1.setLeading(24f);
                paragraph1.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase2 = new Phrase();
                // phrase2.add(new Chunk("经查，你（单位）有",fontChineseKNormal));
                phrase2.add(Pdf_Format.underLine(book.getValue(4), 3312,
                        fontChineseNormalsimfang12));
                ...
                phrase3.add(Pdf_Format.underLine(book.getValue(5), 264,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("的规定，依", fontChineseNormalsimfang12));
                phrase3.add(new Chunk("据", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(6), 396,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("，拟对你（单位）作出", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(7), 336,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("的行政处罚。", fontChineseNormalsimfang12));
                toMeasurefloat(phrase3);
                ...
                phrase5.add(new Chunk("联系人：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(book.getValue(10), 84, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("联系电话：", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format
                        .underLine(book.getValue(11), 84, fontChineseNormalsimfang12));
                phrase5.add(new Chunk("邮编：", fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book18(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                final Paragraph paragraph1_1 = new Paragraph();
                paragraph1_1.setFirstLineIndent(360f);
                paragraph1_1.setLeading(24f);
                paragraph1_1.setAlignment(Element.ALIGN_LEFT);
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(4), 228,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("一案，", fontChineseNormalsimfang12));
                // phrase2.add(Help_Pdf_Help.underLine("", 60,
                // fontChineseKNormal));
                // phrase2.add(new Chunk("年", fontChineseKNormal));
                // phrase2.add(Help_Pdf_Help.underLine("", 48,
                // fontChineseKNormal));
                // phrase2.add(new Chunk("月", fontChineseKNormal));
                // phrase2.add(Help_Pdf_Help.underLine("", 48,
                // fontChineseKNormal));
                // phrase2.add(new Chunk("日", fontChineseKNormal));
                // phrase2.add(Help_Pdf_Help.underLine("", 48,
                // fontChineseKNormal));
                // phrase2.add(new Chunk("时", fontChineseKNormal));
                // phrase2.add(Help_Pdf_Help.underLine("", 48,
                // fontChineseKNormal));
                // phrase2.add(new Chunk("分在", fontChineseKNormal));
                phrase2_1.add(Pdf_Format.underLine(book.getValue(6), 228,
                        fontChineseNormalsimfang12));
                phrase2_1
                        .add(new Chunk("（公开、不公开）举行听证会议，请准时出席。", fontChineseNormalsimfang12));
                ...
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(7), 84, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("职务：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(8), 192,
                        fontChineseNormalsimfang12));
                phrase3.add("\n");
                phrase3.add(new Chunk("听证员姓名：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(9), 108,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("职务：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(10), 192,
                        fontChineseNormalsimfang12));
                phrase3.add("\n");
                phrase3.add(new Chunk("听证员姓名：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(11), 108,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("职务：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(12), 192,
                        fontChineseNormalsimfang12));
                phrase3.add("\n");
                phrase3.add(new Chunk("书记员姓名：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(13), 108,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("职务：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(14), 192,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase10 = new Phrase();
                phrase10.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 0), 36,
                        fontChineseNormalsimfang12));
                phrase10.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase10.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 1), 36,
                        fontChineseNormalsimfang12));
                phrase10.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase10.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 2), 36,
                        fontChineseNormalsimfang12));
                phrase10.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase10);
                ...
                phrase11.add(Pdf_Format.tablenounderLine(book.getValue(16), 252,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("邮 编：", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(book.getValue(17), 372,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("联系人：", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(book.getValue(18), 372,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("联系电话：", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(book.getValue(19), 348,
                        fontChineseNormalsimfang12));
                ...
                phrase18.add(Pdf_Format.underLine(getTime(book.getValue(5), 0), 60,
                        fontChineseNormalsimfang12));
                phrase18.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase18.add(Pdf_Format.underLine(getTime(book.getValue(5), 1), 48,
                        fontChineseNormalsimfang12));
                phrase18.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase18.add(Pdf_Format.underLine(getTime(book.getValue(5), 2), 48,
                        fontChineseNormalsimfang12));
                phrase18.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase18.add(Pdf_Format.underLine(getTime(book.getValue(5), 3), 48,
                        fontChineseNormalsimfang12));
                phrase18.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase18.add(Pdf_Format.underLine(getTime(book.getValue(5), 4), 48,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book19(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase1 = new Phrase();
                phrase1.add(new Chunk("案件名称：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format.underLine(book.getValue(3), 348,
                        fontChineseNormalsimfang12));
                phrase1.add(new Chunk("主持听证机关：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(4), 96, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("地点：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format.underLine(book.getValue(5), 192,
                        fontChineseNormalsimfang12));
                phrase1.add(new Chunk("听证时间：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(6), 0), 60, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(6), 1), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(6), 2), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(6), 3), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(6), 4), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("分至", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(7), 2), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(7), 3), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(7), 4), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("分", fontChineseNormalsimfang12));
                phrase1.add("\n");
                ...
                phrase1.add(Pdf_Format.underLine(book.getValue(9), 108,
                        fontChineseNormalsimfang12));
                ...
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(17), 42, fontChineseNormalsimfang12));

                phrase1.add(new Chunk("工作单位（职务）：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format.underLine(book.getValue(18), 300,
                        fontChineseNormalsimfang12));
                ...
                phrase1.add(new Chunk("性别：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(20), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("年龄：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(21), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("工作单位（职务）：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                ...
                phrase1.add(new Chunk("性别：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(24), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("年龄：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(25), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("工作单位（职务）：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(26), 72, fontChineseNormalsimfang12));

                phrase1.add(new Chunk("第三人：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format.underLine(book.getValue(27), 360,
                        fontChineseNormalsimfang12));
                phrase1.add(new Chunk("其他参与人员：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format.underLine(book.getValue(28), 324,
                        fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph2 = new Paragraph();
                paragraph2.setFirstLineIndent(84f);
                paragraph2.setLeading(24f);
                paragraph2.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase2 = new Phrase();
                // phrase2.add(new Chunk("听证记录：", fontChineseKNormal));
                phrase2.add(Pdf_Format.underLine(book.getValue(29), 3828,
                        fontChineseNormalsimfang12));
                ...
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(30), 84,
                        fontChineseNormalsimfang12));
                phrase3.add("\n");

                phrase3.add(new Chunk("听证主持人（签名）：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(31), 84,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("书记员（签名）：", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(32), 72,
                        fontChineseNormalsimfang12));

                phrase3.add(Pdf_Format.tablenounderLine("", 336,
                        fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(33), 0), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(33), 1), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.tablenounderLine(getTime(book.getValue(33), 2), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("日", fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book20(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase02p0 = new Phrase();
                phrase02p0.add(Pdf_Format.tablenounderLine(book.getValue(4), 90, fontChineseNormalsimfang12));
                lin02p0.add(phrase02p0);
                ...
                phrase04p0.add(Pdf_Format.tablenounderLine(book.getValue(5), 90, fontChineseNormalsimfang12));
                ...
                phrase06p0.add(Pdf_Format.tablenounderLine(book.getValue(6), 90, fontChineseNormalsimfang12));
                ...
                phrase2.add(new Chunk("听证会基本情况摘要：（详见听证会笔录，笔录附后）",
                        fontChineseNormalsimfang12));
                phrase2.add("\n");
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(7), 2232,
                        fontChineseNormalsimfang12));
                lin21p0.add(phrase2);
                ...
                Phrase phrase3 = new Phrase();
                Phrase phrase3_1 = new Phrase();
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(8), 2832,
                        fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine("", 168,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("听证主持人（签名）：", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(book.getValue(9), 176,
                        fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine("\u00a0",
                        272, fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 0), 36,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 1), 36,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(10), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                phrase4.add(Pdf_Format.tablenounderLine(book.getValue(11), 2832,
                        fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine("", 168,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("负责人（签名）：", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(book.getValue(12), 176,
                        fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine("\u00a0",
                        272, fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 0), 36,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 1), 36,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 2), 36,
                        fontChineseNormalsimfang12));
        ...
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                PdfPCell cell31 = new PdfPCell(new Phrase(
                        Pdf_Format.tablenounderLine(book.getValue(5), 15,
                                fontChineseNormalsimfang12)));
                ...
                PdfPCell c1 = new PdfPCell(new Phrase(
                        Pdf_Format.tablenounderLine(book.getValue(7), 6,
                                fontChineseNormalsimfang12)));
                PdfPCell c2 = new PdfPCell(new Phrase(new Chunk("邮编",
                        fontChineseNormalsimfang12)));
                PdfPCell c3 = new PdfPCell(new Phrase(
                        Pdf_Format.tablenounderLine(book.getValue(16), 6,
                                fontChineseNormalsimfang12)));
                table41.addCell(c1);
                table41.addCell(c2);
                table41.addCell(c3);
                ...
                PdfPCell a1 = new PdfPCell(new Phrase(
                        Pdf_Format.tablenounderLine(book.getValue(10), 6,
                                fontChineseNormalsimfang12)));
                PdfPCell a2 = new PdfPCell(new Phrase(new Chunk("性别",
                        fontChineseNormalsimfang12)));
                PdfPCell a3 = new PdfPCell(new Phrase(
                        Pdf_Format.tablenounderLine(book.getValue(11), 6,
                                fontChineseNormalsimfang12)));
                table42.addCell(a1);
                table42.addCell(a2);
                table42.addCell(a3);
                ...
                PdfPCell cell34 = new PdfPCell(new Phrase(
                        Pdf_Format.tablenounderLine(book.getValue(13), 15,
                                fontChineseNormalsimfang12)));
                ...
                PdfPCell b1 = new PdfPCell(new Phrase(
                        Pdf_Format.tablenounderLine(book.getValue(15), 6,
                                fontChineseNormalsimfang12)));
                ...
                Phrase phrase22p0 = new Phrase();
                phrase22p0.add(Pdf_Format.tablenounderLine(book.getValue(17), 1116, fontChineseNormalsimfang12));
                lin22p0.add(phrase22p0);
                ...
                Phrase phrase32p0 = new Phrase();
                phrase32p0.add(Pdf_Format.tablenounderLine(book.getValue(18), 1116, fontChineseNormalsimfang12));
                lin32p0.add(phrase32p0);
                ...
                Phrase phrase2 = new Phrase();
                Phrase phrase2_1 = new Phrase();
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(19), 1696,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("承办人（签名）：", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.underLine(book.getValue(20), 72,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.underLine(book.getValue(21), 72,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(22), 0), 36,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(22), 1), 36,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(22), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase3 = new Phrase();
                Phrase phrase3_1 = new Phrase();
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(23), 20,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("审核人（签名）:", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(book.getValue(24), 120,
                        fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 0), 36,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 1), 36,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 2), 36,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("日", fontChineseNormalsimfang12));
                lin52p0.add(phrase3);
                ...
                Phrase phrase4 = new Phrase();
                Phrase phrase4_1 = new Phrase();
                phrase4.add(Pdf_Format.tablenounderLine(book.getValue(26), 20,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("审批人（签名）:", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(book.getValue(27), 120,
                        fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(28), 0), 36,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(28), 1), 36,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(28), 2), 36,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("日", fontChineseNormalsimfang12));
                lin54p0.add(phrase4);
    ...
    public void printerEntity_Book22(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 1), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 2), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("日", fontChineseNormalsimfang12));
                ...
                phrase1.add(new Chunk("分至", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(5), 2), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(5), 3), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("时", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(getTime(book.getValue(5), 4), 24, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("分", fontChineseNormalsimfang12));
                phrase1.add("\n");
                phrase1.add(new Chunk("地点：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format.underLine(book.getValue(6), 372,
                        fontChineseNormalsimfang12));

                phrase1.add(new Chunk("主持人：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(7), 88, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("汇报人：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(8), 88, fontChineseNormalsimfang12));
                phrase1.add(new Chunk("记录人：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format
                        .underLine(book.getValue(9), 88, fontChineseNormalsimfang12));
                phrase1.add("\n");
                ...
                Phrase phrase2 = new Phrase();
                phrase2.add(Pdf_Format.underLine(book.getValue(10), 2160,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase3 = new Phrase();
                // phrase3.add(new Chunk("讨论内容：", fontChineseKNormal));
                phrase3.add(Pdf_Format.underLine(book.getValue(11), 2532,
                        fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph4 = new Paragraph();
                paragraph4.setFirstLineIndent(84f);
                paragraph4.setLeading(15f);
                paragraph4.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase4 = new Phrase();
                // phrase4.add(new Chunk("讨论记录：", fontChineseKNormal));
                phrase4.add(Pdf_Format.underLine(book.getValue(12), 5988,
                        fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph5 = new Paragraph();
                paragraph5.setFirstLineIndent(96f);
                paragraph5.setLeading(15f);
                paragraph5.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase5 = new Phrase();
                // phrase5.add(new Chunk("结论性意见：", fontChineseKNormal));
                phrase5.add(Pdf_Format.underLine(book.getValue(13), 1632,
                        fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph6 = new Paragraph();
                paragraph6.setFirstLineIndent(108f);
                paragraph6.setLeading(15f);
                paragraph6.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase6 = new Phrase();
                // phrase6.add(new Chunk("出席人员签名：", fontChineseKNormal));
                phrase6.add(Pdf_Format.underLine(book.getValue(14), 1188,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book23(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(Pdf_Format.underLine(book.getValue(3), 336,
                        fontChineseNormalsimfang12));

                Phrase phrase2 = new Phrase();
                phrase2.add(new Chunk("地 址：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(4), 216,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("邮编：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 108,
                        fontChineseNormalsimfang12));
                ...
                phrase3.add(new Chunk("职务:", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(6), 48, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("联系电话:", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(8), 60, fontChineseNormalsimfang12));
                ...
                final Paragraph paragraph2 = new Paragraph();
                paragraph2.setFirstLineIndent(120f);
                paragraph2.setLeading(24f);
                paragraph2.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase4 = new Phrase();
                // phrase4.add(new Chunk("违法事实及证据", fontChineseKNormal));
                phrase4.add(Pdf_Format.underLine(book.getValue(9), 2328,
                        fontChineseNormalsimfang12));
                ...
                phrase5.add(Pdf_Format.underLine(book.getValue(10), 324,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("的规定，依据", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine(book.getValue(11), 264,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("的规定，决定给予", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine(book.getValue(12), 342,
                        fontChineseNormalsimfang12));
                ...
                phrase6.add(Pdf_Format.underLine(book.getValue(14), 192,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("，账号", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(15), 180,
                        fontChineseNormalsimfang12));
                ...
                phrase7.add(Pdf_Format.underLine(book.getValue(16), 120,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase11 = new Phrase();
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(22), 0), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(22), 1), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(22), 2), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase11);
                ...
                PdfContentByte cb = dpfwPdfWriter.getDirectContent();
                RadioCheckField bt = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(105, 347, 10), "Yes436",
                ...
                RadioCheckField bt2 = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(105, 323, 10), "Yes486",
    ...
    public void printerEntity_Book24(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase1.add(Pdf_Format.underLine(book.getValue(6), 108,
                        fontChineseNormalsimfang12));

                Phrase phrase2 = new Phrase();
                phrase2.add(new Chunk("家庭住址：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(7), 144,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("所在单位：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(8), 144,
                        fontChineseNormalsimfang12));
                ...
                phrase3.add(new Chunk("联系电话:", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(book.getValue(11), 96, fontChineseNormalsimfang12));
                ...
                Phrase phrase4 = new Phrase();
                // phrase4.add(new Chunk("违法事实及证据", fontChineseKNormal));
                phrase4.add(Pdf_Format.underLine(book.getValue(12), 2328,
                        fontChineseNormalsimfang12));
                phrase4.add(new Chunk("（此栏不够，可另附页）", fontChineseNormalsimfang12));
                ...
                Phrase phrase5 = new Phrase();
                phrase5.add(new Chunk("以上事实违反了", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine(book.getValue(13), 324,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("的规定，依据", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine(book.getValue(14), 264,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("的规定，决定给予", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.underLine(book.getValue(15), 342,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("的行政处罚。", fontChineseNormalsimfang12));
                ...
                Phrase phrase6 = new Phrase();
                phrase6.add(new Chunk("自收到本决定书之日起15日内缴至", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(17), 192,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("，账号", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(18), 180,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("，到期不缴每日按罚款款数额的3%加处罚款。", fontChineseNormalsimfang12));
                ...
                Phrase phrase7 = new Phrase();
                phrase7.add(new Chunk("如果不服本决定，可以依法在60日内向", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.underLine(book.getValue(19), 120,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("人民政府或者", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format
                ...
                Phrase phrase11 = new Phrase();
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 0), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 1), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(25), 2), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase11);
                ...
                PdfContentByte cb = dpfwPdfWriter.getDirectContent();
                RadioCheckField bt = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(105, 347, 10), "Yes274",
                ...
                RadioCheckField bt2 = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(105, 323, 10), "Yes470",
    ...
    public void printerEntity_Book25(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase4 = new Phrase();
                // phrase4.add(new Chunk("违法事实及证据", fontChineseKNormal));
                phrase4.add(Pdf_Format.underLine(book.getValue(9), 2784,
                        fontChineseNormalsimfang12));
                phrase4.add(new Chunk("（此栏不够，可另附页）", fontChineseNormalsimfang12));
                ...
                phrase6.add(new Chunk("处以罚款的，罚款自收到本决定书之日起15日内缴至",
                        fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(13), 120,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("，账号", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(14), 120,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("，到期不缴每日按罚款款数额的3%加处罚款。", fontChineseNormalsimfang12));
                ...
                Phrase phrase7 = new Phrase();
                phrase7.add(new Chunk("如果不服本决定，可以依法在60日内向", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.underLine(book.getValue(15), 120,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("人民政府或者", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format
    ...
    public void printerEntity_Book26(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase4 = new Phrase();
                // phrase4.add(new Chunk("违法事实及证据", fontChineseKNormal));
                phrase4.add(Pdf_Format.underLine(book.getValue(12), 2784,
                        fontChineseNormalsimfang12));
                phrase4.add(new Chunk("（此栏不够，可另附页）", fontChineseNormalsimfang12));
                ...
                phrase6.add(new Chunk("处以罚款的，罚款自收到本决定书之日起15日内缴至",
                        fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(16), 120,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("，账号", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.underLine(book.getValue(17), 120,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("，到期不缴每日按罚款款数额的3%加处罚款。", fontChineseNormalsimfang12));
                ...
                Phrase phrase7 = new Phrase();
                phrase7.add(new Chunk("如果不服本决定，可以依法在60日内向", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format.underLine(book.getValue(18), 120,
                        fontChineseNormalsimfang12));
                phrase7.add(new Chunk("人民政府或者", fontChineseNormalsimfang12));
                phrase7.add(Pdf_Format
                ...
                Phrase phrase11 = new Phrase();
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 0), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 1), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase11.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 2), 36,
                        fontChineseNormalsimfang12));
                phrase11.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase11);
    ...
    public void printerEntity_Book27(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase2.add(new Chunk("本机关于", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 0), 48, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 1), 48, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(4), 2), 48, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("日发出", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 132,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("号行政处罚决定书，要求你（单位）于", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(6), 0), 48, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(6), 1), 48, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format
                        .underLine(getTime(book.getValue(6), 2), 48, fontChineseNormalsimfang12));
                ...
                Phrase phrase5 = new Phrase();
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(8), 0), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(8), 1), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(8), 2), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase5);
    ...
    public void printerEntity_Book28(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase02p.add(Pdf_Format.tablenounderLine(book.getValue(3), 272, fontChineseNormalsimfang12));
                ...
                phrase12p.add(Pdf_Format.tablenounderLine(book.getValue(4), 744, fontChineseNormalsimfang12));
                ...
                phrase32p.add(Pdf_Format.tablenounderLine(book.getValue(5), 124, fontChineseNormalsimfang12));
                ...
                phrase34p.add(Pdf_Format.tablenounderLine(book.getValue(6), 124, fontChineseNormalsimfang12));
                ...
                phrase42p.add(Pdf_Format.tablenounderLine(book.getValue(7), 1488, fontChineseNormalsimfang12));
                ...
                phrase52p.add(Pdf_Format.tablenounderLine(book.getValue(8), 1488, fontChineseNormalsimfang12));
                ...
                phrase1.add(Pdf_Format.tablenounderLine(book.getValue(9), 332,
                        fontChineseNormalsimfang12));
                phrase1_1.add(new Chunk("承办人（签名）：", fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.underLine(book.getValue(10), 60,
                        fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.underLine(book.getValue(11), 60,
                        fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.tablenounderLine("", 100,
                        fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.tablenounderLine("", 100,
                        fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.tablenounderLine("", 224,
                        fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 0), 36,
                        fontChineseNormalsimfang12));
                phrase1_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 1), 36,
                        fontChineseNormalsimfang12));
                phrase1_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase1_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(13), 864,
                        fontChineseNormalsimfang12));
                phrase21.add(new Chunk("审核人（签名）：", fontChineseNormalsimfang12));
                phrase21.add(Pdf_Format.tablenounderLine(book.getValue(14), 108,
                        fontChineseNormalsimfang12));
                phrase21.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 0), 36,
                        fontChineseNormalsimfang12));
                phrase21.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase21.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 1), 36,
                        fontChineseNormalsimfang12));
                phrase21.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase21.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                phrase82.add(Pdf_Format.tablenounderLine(book.getValue(16), 884,
                        fontChineseNormalsimfang12));
                phrase821.add(new Chunk("审批人（签名）：", fontChineseNormalsimfang12));
                phrase821.add(Pdf_Format.tablenounderLine(book.getValue(17), 108,
                        fontChineseNormalsimfang12));
                phrase821.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 0), 36,
                        fontChineseNormalsimfang12));
                phrase821.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase821.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 1), 36,
                        fontChineseNormalsimfang12));
                phrase821.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase821.add(Pdf_Format.tablenounderLine(getTime(book.getValue(17), 2), 36,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book29(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 120,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("号《行政处罚决定书》，作出了对你（单位）罚款", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(6), 168,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk(
                ...
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(8), 0), 36, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(8), 1), 36, fontChineseNormalsimfang12));
                phrase3.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format
                        .underLine(getTime(book.getValue(8), 2), 36, fontChineseNormalsimfang12));
                ...
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(10), 0), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(10), 1), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(10), 2), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("日（大写）前，缴纳罚款", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(11), 120,
                        fontChineseNormalsimfang12));
                phrase4.add(new Chunk("元（大写）（每期均应当单独开具本文书）。此外，尚有未缴纳的罚款",
                        fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.underLine(book.getValue(12), 120,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase13 = new Phrase();
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 0), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 1), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(13), 2), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase13);
                ...
                PdfContentByte cb = dpfwPdfWriter.getDirectContent();
                RadioCheckField bt = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(104, 543, 10), "Yes380",
                        getCheck(book.getValue(7), 1));
                bt.setCheckType(RadioCheckField.TYPE_CHECK);
                bt.setBorderWidth(BaseField.BORDER_WIDTH_THIN);
                bt.setBorderColor(BaseColor.BLACK);
                ...
                RadioCheckField bt2 = new RadioCheckField(dpfwPdfWriter,
                        Pdf_Format.setCheckBoxArea(104, 520, 10), "Yes303",
                        getCheck(book.getValue(7), 2));
                bt2.setCheckType(RadioCheckField.TYPE_CHECK);
                bt2.setBorderWidth(BaseField.BORDER_WIDTH_THIN);
                bt2.setBorderColor(BaseColor.BLACK);
    ...
    public void printerEntity_Book30(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase02p = new Phrase();
                phrase02p.add(Pdf_Format.tablenounderLine(book.getValue(4), 200, fontChineseNormalsimfang12));
                cell02p.add(phrase02p);
                cell02.addElement(cell02p);
                table1.addCell(cell01);
                table1.addCell(cell02);
                ...
                paragraph2.add("\n");
                paragraph2.add(Pdf_Format.tablenounderLine("", 264,
                        fontChineseNormalsimfang12));
                ...
                paragraph3.add(Pdf_Format.tablenounderLine(book.getValue(6), 60,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book31(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase1 = new Phrase();
                phrase1.add((Pdf_Format.underLine(book.getValue(3), 120,
                        fontChineseNormalsimfang12)));
                ...
                phrase2.add(Pdf_Format
                        .underLine(book.getValue(5), 96, fontChineseNormalsimfang12));
                phrase2.add(new Chunk("作出了", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.underLine(book.getValue(6), 288,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk("的行政处罚决定（文号：", fontChineseNormalsimfang12));
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(7), 288,
                        fontChineseNormalsimfang12));
                phrase2.add(new Chunk(
                ...
                Phrase phrase12 = new Phrase();
                phrase12.add(Pdf_Format.tablenounderLine(book.getValue(8), 8600, fontChineseNormalsimfang12));
                toMeasurefloat(phrase12);
                ...
                Phrase phrase5 = new Phrase();
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(9), 0), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(9), 1), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase5.add(Pdf_Format.tablenounderLine(getTime(book.getValue(9), 2), 36,
                        fontChineseNormalsimfang12));
                phrase5.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase5);
                ...
                phrase6.add(Pdf_Format.tablenounderLine(book.getValue(10), 156,
                        fontChineseNormalsimfang12));
                phrase6.add(new Chunk("联系电话：", fontChineseNormalsimfang12));
                phrase6.add(Pdf_Format.tablenounderLine(book.getValue(11), 156,
                        fontChineseNormalsimfang12));
                toMeasurefloat(phrase6);
                paragraph5.add(phrase6);
        ...
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                PdfPCell c2 = new PdfPCell(new Phrase(new Chunk("邮编",
                        fontChineseNormalsimfang12)));
                PdfPCell c3 = new PdfPCell(new Phrase(
                        Pdf_Format.tablenounderLine(book.getValue(8), 6,
                                fontChineseNormalsimfang12)));
                table41.addCell(c1);
                table41.addCell(c2);
                table41.addCell(c3);
                ...
                lin22p0.setLeading(24f);
                Phrase phrase22p0 = new Phrase();
                phrase22p0.add(Pdf_Format.tablenounderLine(book.getValue(17), 1488, fontChineseNormalsimfang12));
                lin22p0.add(phrase22p0);
                lin22.addElement(lin22p0);
                PdfPTable cellTable2 = new PdfPTable(2);
                float[] celltable1float = new float[2];
                ...
                Phrase phrase2 = new Phrase();
                Phrase phrase2_1 = new Phrase();
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(18), 1696,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("承办人（签名）：", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.underLine(book.getValue(19), 72,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.underLine(book.getValue(20), 72,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 0), 36,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 1), 36,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(21), 2), 36,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("日", fontChineseNormalsimfang12));
                ...
                Phrase phrase3 = new Phrase();
                Phrase phrase3_1 = new Phrase();
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(22), 288,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("审核人（签名）:", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(book.getValue(23), 144,
                        fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(24), 0), 36,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(24), 1), 36,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase3_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(24), 2), 36,
                        fontChineseNormalsimfang12));
                phrase3_1.add(new Chunk("日", fontChineseNormalsimfang12));
                lin52p0.add(phrase3);
                lin52p02.add(phrase3_1);
                ...
                Phrase phrase4 = new Phrase();
                Phrase phrase4_1 = new Phrase();
                phrase4.add(Pdf_Format.tablenounderLine(book.getValue(25), 288,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("审批人（签名）:", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(book.getValue(26), 144,
                        fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(27), 0), 36,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(27), 1), 36,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase4_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(27), 2), 36,
                        fontChineseNormalsimfang12));
                phrase4_1.add(new Chunk("日", fontChineseNormalsimfang12));
                lin54p0.add(phrase4);
                lin54p02.add(phrase4_1);
    ...
    public void printerEntity_Book33(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                Phrase phrase2 = new Phrase();
                Phrase phrase2_1 = new Phrase();
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(9), 1296,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("承办人（签名）：", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.underLine(book.getValue(10), 60,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.underLine(book.getValue(11), 60,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 0), 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 1), 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase2_1.add(Pdf_Format.tablenounderLine(getTime(book.getValue(12), 2), 24,
                        fontChineseNormalsimfang12));
                phrase2_1.add(new Chunk("日", fontChineseNormalsimfang12));
                ...
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(13), 150,
                        fontChineseNormalsimfang12));
                phrase31.add(Pdf_Format.tablenounderLine("", 150,
                        fontChineseNormalsimfang12));
                phrase31.add(new Chunk("审核人（签名）：", fontChineseNormalsimfang12));
                phrase31.add(Pdf_Format.tablenounderLine(book.getValue(14), 96,
                        fontChineseNormalsimfang12));
                phrase31.add(Pdf_Format.tablenounderLine("", 150,
                        fontChineseNormalsimfang12));
                phrase31.add(Pdf_Format.tablenounderLine("", 150,
                        fontChineseNormalsimfang12));
                phrase31.add(Pdf_Format.tablenounderLine("", 36,
                        fontChineseNormalsimfang12));
                phrase31.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 0), 36,
                        fontChineseNormalsimfang12));
                phrase31.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase31.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 1), 36,
                        fontChineseNormalsimfang12));
                phrase31.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase31.add(Pdf_Format.tablenounderLine(getTime(book.getValue(15), 2), 36,
                        fontChineseNormalsimfang12));
                ...
                phrase4.add(Pdf_Format.tablenounderLine(book.getValue(16), 150,
                        fontChineseNormalsimfang12));
                phrase41.add(Pdf_Format.tablenounderLine("", 150,
                        fontChineseNormalsimfang12));
                phrase41.add(new Chunk("审批人（签名）：", fontChineseNormalsimfang12));
                phrase41.add(Pdf_Format.tablenounderLine(book.getValue(17), 96,
                        fontChineseNormalsimfang12));
                phrase41.add(Pdf_Format.tablenounderLine("", 150,
                        fontChineseNormalsimfang12));
                phrase41.add(Pdf_Format.tablenounderLine("", 150,
                        fontChineseNormalsimfang12));
                phrase41.add(Pdf_Format.tablenounderLine("", 36,
                        fontChineseNormalsimfang12));
                phrase41.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 0), 36,
                        fontChineseNormalsimfang12));
                phrase41.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase41.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 1), 36,
                        fontChineseNormalsimfang12));
                phrase41.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase41.add(Pdf_Format.tablenounderLine(getTime(book.getValue(18), 2), 36,
                        fontChineseNormalsimfang12));
    ...
    public void printerEntity_Book34(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                final Paragraph paragraph1_1 = new Paragraph();
                paragraph1_1.setFirstLineIndent(180f);
                paragraph1_1.setLeading(24f);
                paragraph1_1.setAlignment(Element.ALIGN_LEFT);

                final Paragraph paragraph1_2 = new Paragraph();
                paragraph1_2.setFirstLineIndent(228);
                paragraph1_2.setLeading(24f);
                paragraph1_2.setAlignment(Element.ALIGN_LEFT);
                ...
                phrase2.add(Pdf_Format.underLine(book.getValue(5), 204,
                        fontChineseNormalsimfang12));
                // phrase2.add(new Chunk("一案立案调查，因在调查中发现", fontChineseKNormal));
                phrase2_1.add(Pdf_Format.underLine(book.getValue(6), 2856,
                        fontChineseNormalsimfang12));
                // phrase2.add(new Chunk("，故此案已超过本行行政机关管辖范围，根据",
                // fontChineseKNormal));
                phrase2_2.add(Pdf_Format.underLine(book.getValue(7), 642,
                        fontChineseNormalsimfang12));
                phrase2_2
                ...
                final Paragraph paragraph2 = new Paragraph();
                paragraph2.setFirstLineIndent(132f);
                paragraph2.setLeading(24f);
                paragraph2.setAlignment(Element.ALIGN_LEFT);

                Phrase phrase3 = new Phrase();
                // phrase3.add(new Chunk("附该案件有关材料：", fontChineseKNormal));
                phrase3.add(Pdf_Format.underLine(book.getValue(8), 1608,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("共", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(9), 36,
                        fontChineseNormalsimfang12));
                phrase3.add(new Chunk("份", fontChineseNormalsimfang12));
                phrase3.add(Pdf_Format.underLine(book.getValue(10), 36,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase13 = new Phrase();
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(11), 0), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(11), 1), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase13.add(Pdf_Format.tablenounderLine(getTime(book.getValue(11), 2), 36,
                        fontChineseNormalsimfang12));
                phrase13.add(new Chunk("日", fontChineseNormalsimfang12));
                toMeasurefloat(phrase13);
    ...
    public void printerEntity_Book35(final Base_Entity book, final Object image) {
        printFrameWork(book, image, new IPdf_BackFrame() {
            ...
            public void writeContent() throws Exception {
                ...
                titlePhrase.add(Pdf_Format.underLine(book.getValue(3), 72,
                        fontChineseNormalsimfang12));
                ...
                Phrase phrase1 = new Phrase();
                phrase1.add(new Chunk("案件名称：", fontChineseNormalsimfang12));
                phrase1.add(Pdf_Format.underLine(book.getValue(4), 372,
                        fontChineseNormalsimfang12));
                paragraph1.add(phrase1);
                ...
                cell2p.setLeading(24f);
                Phrase phrase2 = new Phrase();
                phrase2.add(Pdf_Format.tablenounderLine(book.getValue(5), 200,
                        fontChineseNormalsimfang12));
                cell2p.add(phrase2);
                ...
                cell4p.setLeading(24f);
                Phrase phrase3 = new Phrase();
                phrase3.add(Pdf_Format.tablenounderLine(book.getValue(6), 200,
                        fontChineseNormalsimfang12));
                cell4p.add(phrase3);
                ...
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(7), 0), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(7), 1), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(7), 2), 36, fontChineseNormalsimfang12));
                ...
                phrase4.add(Pdf_Format
                        .underLine(book.getValue(9), 84, fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format.tablenounderLine("", 24,
                        fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(book.getValue(10), 84, fontChineseNormalsimfang12));
                phrase4.add("\n");
                ...
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(11), 0), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("年", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(11), 1), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("月", fontChineseNormalsimfang12));
                phrase4.add(Pdf_Format
                        .underLine(getTime(book.getValue(11), 2), 36, fontChineseNormalsimfang12));
                phrase4.add(new Chunk("日", fontChineseNormalsimfang12));
                phrase4.add("\n");
