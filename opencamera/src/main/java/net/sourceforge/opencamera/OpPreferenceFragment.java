 ...
 *  communication to be via the bundle (since this replaced the OpMainActivity,
 ...
 */
public class OpPreferenceFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
	private static final String TAG = "OpPreferenceFragment";
        	...
        	pref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
            		...
            		if( newValue.equals("preference_raw_yes") ) {
            			...
            			if( !done_raw_info ) {
	        		        AlertDialog.Builder alertDialog = new AlertDialog.Builder(OpPreferenceFragment.this.getActivity());
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_online_help") ) {
	            		...
	            		OpMainActivity main_activity = (OpMainActivity)OpPreferenceFragment.this.getActivity();
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_donate") ) {
            	        ...
            	        /*Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(OpMainActivity.getDonateMarketLink()));
            	        try {
                	        ...
                	        browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(OpMainActivity.getDonateLink()));
            	        	startActivity(browserIntent);
            			}*/
            	        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(OpMainActivity.getDonateLink()));
        	        	startActivity(browserIntent);
                		return false;
                	}
                	return false;
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_about") ) {
                        ...
                        int version_code = -1;
						try {
	                        PackageInfo pInfo = OpPreferenceFragment.this.getActivity().getPackageManager().getPackageInfo(OpPreferenceFragment.this.getActivity().getPackageName(), 0);
                        ...
                        about_string.append("\nPackage: ");
                        about_string.append(OpPreferenceFragment.this.getActivity().getPackageName());
                        about_string.append("\nAndroid API version: ");
                        ...
                        }
                        {
                            ...
                            Display display = OpPreferenceFragment.this.getActivity().getWindowManager().getDefaultDisplay();
            ...
            pref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference arg0) {
                	if( pref.getKey().equals("preference_reset") ) {
    				    ...
    				    new AlertDialog.Builder(OpPreferenceFragment.this.getActivity())
	 ...
	 * OpMainActivity.onActivityResult).
	 */
